...
interface ArtistPasswordChangeProps {
  onClose: () => void;
}

export function ArtistPasswordChange({ onClose }: ArtistPasswordChangeProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await api.artistAuth.changePassword(currentPassword, newPassword);
...
export default ArtistPasswordChange;
